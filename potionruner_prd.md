...
- **ReplyKeyboardMarkup** + emoji, teks ramah:
  - Saat proses lama → kirim pesan: *“Waduh, sepertinya sedang ramai… tunggu sebentar ya 🧃”*
...
**Contoh gaya bahasa**
- Saat proses: *“Waduh, sepertinya sedang ramai… tunggu sebentar ya 🧃. Lagi siapin datanya nih…”*
- Setelah proses:
...
- `PROCESSING`: "Waduh, sepertinya sedang ramai… tapi tunggu sebentar ya 🧃. Lagi siapin datamu nih…"
- `DONE_OK`: "Sudah siap nih! ✅ Info singkat: {summary}"
- `DONE_FAIL`: "Hmm, ada kendala nih ❌. Rangkuman error: {error}. Coba lagi ya."
- `CONFIRM`: "Yakin mau {action}? Balas *YA* untuk lanjut."
